...
vi.mock('../lib/tailscale',()=>({ensureTailscale:transport.ensure,suspendTailscale:transport.stop,getTailscaleSnapshot:()=>({state:transport.state}),subscribeTailscale:transport.sub}));
